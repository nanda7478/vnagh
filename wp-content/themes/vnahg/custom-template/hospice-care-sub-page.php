<?php
/*
 Display Template Name: Sub Hospice Care Service
*/
get_header();
?>
...
<section class="our_specialties_section">
	<div class="container">
      ...
      <div class="item">
          ...
          <a href="<?php the_sub_field('specilties_url');?>"> <span> Explore </span> <?php the_sub_field('specilties_title');?></a> 
      </div>
<?php endwhile;?>
     </div>
           </div>
...
<a href="<?php the_field('vna_home_care_url');?>">
