<?php
/*
 Display Template Name: Joint Venture Partners
*/
get_header();
?>
...
<?php while(have_rows('have_questions_section')): the_row();?>
                  ...
                  <span><?php the_sub_field('have_question_subtitle');?></span>
				<?php endwhile;?>
 </div>
...
<section class="our_specialties_section clearfix">
	<div class="container">
      ...
      ?>
      <div class="item"> <a href="<?php the_sub_field('specilties_url');?>"> <span> Explore </span> <?php the_sub_field('specilties_title');?></a> </div>
<?php endwhile;?>
     </div>
           </div>
