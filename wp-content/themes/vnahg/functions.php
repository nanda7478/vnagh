...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'About Menu', 'twentysixteen' ),
		'id'            => 'sidebar-4',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => __( 'Services Menu', 'twentysixteen' ),
		'id'            => 'sidebar-5',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => __( 'Contact Menu', 'twentysixteen' ),
		'id'            => 'sidebar-6',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
   ...
   register_sidebar( array(
		'name'          => __( 'AAA Section', 'twentysixteen' ),
		'id'            => 'sidebar-9',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
/****************************custom post type for leadership*********/
...
/****************************custom post type for Video Gallery*********/
...
function video_post_type()
{
  $labels = array(
    ...
    'not_found' =>  __('No Video Gallery found'),
    'not_found_in_trash' => __('No Video Gallery found in Trash'),
    'parent_item_colon' => '',
 ...
 $args = array(
  ...
  // The following is the main step where we register the post.
  register_post_type('video-galleries',$args);
